...
public class RadioButtons {
    public static void main(String[] args) {
        ...
        if (status){
            System.out.println("the radio male button was selected");
        }else{
            System.out.println("the radio male button was not selected");
        }
        ...
        System.out.println("the radio male button is displayed "+ btnDisplayedStatus);

        // find the age range select 5-25
